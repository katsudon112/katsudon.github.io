...
var strShapeName	= "Имя фигуры";
var strShapeText	= "Текст фигуры";
var strProps		= "Данные фигуры";
var strResults		= "Результаты поиска для:";

var strShape	= "Имя фигуры:";
var strNoCustomPropertiesToDisplayText = "Для просмотра подробностей щелкните фигуру, удерживая нажатой клавишу CTRL.";
...
function FindOnClick()
{
	...
	if (searchTokensArray.length > 0)
	{
		...
		var strResultsHTML = "Совпадения не найдены.";
		var lastPageID = null;
		var shapeID;
		...
		if(ArrayLength > 0)
		{
			...
			for ( count = 0; count < ArrayLength; count++)
			{
				...
				strResultsHTML += '<p class="results"><a href="javascript:populateSearchResultDetails(\'results_'+ lastPageID +'_'+ shapeID +'\', '+ lastPageID +','+ shapeID +'); TogglePlus(\'results_' + lastPageID + '_' + shapeID + '\',\'img_' + lastPageID + '_' + shapeID + '\', hideResults)"><img src="plus.gif" style="padding-left:13px" alt="Отображение или скрытие сведений фигур" width="13" height="9" border="0" id="img_'+ lastPageID +'_'+ shapeID +'"></a>\n'
